...
public class DecoratorPatternExample {
    public static void main(String[] args) {
        ...
        // 也可以直接创建复杂的组合
        System.out.println("\n--- 直接创建复杂咖啡 ---");
        Coffee complexCoffee = new VanillaCoffee(new WhipCoffee(new MilkCoffee(new SimpleCoffee())));
        ...
        // 创建不同的组合
        System.out.println("\n--- 不同的组合 ---");
        Coffee anotherCoffee = new WhipCoffee(new VanillaCoffee(new SimpleCoffee()));
